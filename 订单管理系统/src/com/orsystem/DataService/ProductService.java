...
public class ProductService {
	...
	//更新商品信息方法2
	public void update(Product p) throws IOException, ClassNotFoundException, SQLException{
		String sql="update product set productname='"+p.getProductName()+"',productclass='"+p.getProductClass()
